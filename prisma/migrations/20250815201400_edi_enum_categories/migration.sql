/*
  ...
  - The values [Spacy] on the enum `Categories` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "Categories_new" AS ENUM ('Pickup', 'Burger', 'Sushi', 'Pizza', 'Asian', 'Donat', 'Ice', 'Spicy');
